              ...
              child: ListView(
                ...
                children: [
                  ListTile(
                    ...
                    subtitle: Text(
                        "Su firma digital debe tener fondo transaparente."),
                    leading: Icon(
                            ...
                            return AlertDialog(
                              ...
                              content: Container(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    Text(
                                        "Las dimensiones de la imagen debe de ser 500px por 500px."),
                                    Padding(padding: EdgeInsets.all(10)),
                                    Text(
                                        "El fondo de la imagen debe de ser transparente."),
                                    Padding(padding: EdgeInsets.all(10)),
                                    Text(
                                        "La firma tiene que ser legible y de trazo gruesas.")
                                  ],
                                ),
                              ),
                            );
                  ...
                  ListTile(
                    ...
                    subtitle:
                        Text("Puede visualizar un ejemplo selecionando aquí."),
                    leading: Icon(
                      Icons.image, 
                    ),
                    onTap: () {
                                ...
                                title: Container(
                                  child: Card(
                                      ...
                                      child: Container(
                                        ...
                                        child: Image.asset(
                                            "assets/firma_digital_v1.png"),
                                      )),
                                ),
                                subtitle: Text(
                                    "(*) El fondo gris se colocó para verificar la transparencia de la imagen."),
                              ),
                            );
                          });
                    },
                  ...
                  ListTile(
                    ...
                    subtitle: Text(
                        "Su firma digital se mostrará en las investigaciones aprobadas."),
                    leading: Icon(
                      Icons.handyman, 
                    ),
                    onTap: () {
                            ...
                            return AlertDialog(
                              ...
                              content: Container(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    Text(
                                        "Su firma digital se utilizará para los siguientes puntos:"),
                                    Padding(padding: EdgeInsets.all(10)),
                                    Text(
                                        " - En los certificados de investigaciones aprobadas."),
                                    Padding(padding: EdgeInsets.all(10)),
                                    Text(" - Su firma ."),
                                  ],
                                ),
                  ...
                  ListTile(
                    ...
                    subtitle: Text(
                        "Su firma digital está protegida con una contraseña."),
                    leading: Icon(
                      Icons.security, 
                    ),
                  )
              ...
              ? () async {
                  if (!isBusy) {
                    ...
                    Dialogs.confirm(context,
                            ...
                            message:
                                "De preferencia la imagen de su firma debe estar en un fondo blanco o transparente.")
                        .then((value) async {
                      ...
                      if (session != null) {
                        ...
                        bool success = await SigningApiProvider.createSigning(
                            context, signingEntity);
                  ...
                  if (!isBusy) {
                    ...
                    Dialogs.confirm(context,
                      ...
                      if (session != null) {
                        ...
                        print(signingEntity.toJson());
                        bool success = await SigningApiProvider.updateSigning(
                            context, signingEntity);
                        if (success) {
                          setState(() {
                            getSigningByUser =
